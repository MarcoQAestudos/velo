...
const Success = () => {
  ...
  const isEnAnalise = order.status === 'EM_ANALISE';
        ...
        <div className="text-center mb-8">
          <h1
            ...
            className={cn(
              ...
              isApproved ? 'text-success' : isEnAnalise ? 'text-amber-500' : 'text-destructive'
            )}
          >
            {isApproved ? 'Pedido Aprovado!' : isEnAnalise ? 'Pedido em Análise!' : 'Crédito Reprovado'}
          </h1>
          <p className="text-muted-foreground">
            {isApproved
              ? 'Seu pedido foi processado com sucesso. Em breve entraremos em contato.'
              : isEnAnalise 
                ? 'Seu pedido está em análise de crédito. Você receberá um retorno em breve.'
